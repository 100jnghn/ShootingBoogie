...
public class iOSChat : MonoBehaviour
{
    // 이동 속도
    ...
    void MoveObject()
    {
        ...
        if (Input.touchCount > 0)
        {
            ...
            float horizontal = touch.deltaPosition.x * moveSpeed * Time.deltaTime;
            float vertical = touch.deltaPosition.y * moveSpeed * Time.deltaTime;
